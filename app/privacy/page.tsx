...
export const metadata = {
  title: "Privacy Policy — Fire Door Network",
  description: "Privacy policy for Fire Door Network.",
};
    ...
    <main className="min-h-dvh bg-black text-white">
      <div className="container mx-auto max-w-3xl px-4 py-16 sm:px-6">
        ...
        <p className="mt-3 text-sm text-white/70">
          How Fire Door Network operates and what it means for users and inspectors.
        </p>
