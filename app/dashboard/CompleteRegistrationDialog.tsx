...
export function CompleteRegistrationDialog({ open, onClose, onCompleted }: Props) {
  ...
  const field =
    "mt-1.5 min-h-12 w-full rounded-xl border border-black/10 bg-white px-3 py-2.5 text-sm text-black placeholder:text-black/40 outline-none transition-colors focus:border-black/25 focus:ring-2 focus:ring-black/10 sm:px-4";

  const selectField =
    "mt-1.5 min-h-12 w-full rounded-xl border border-black/10 bg-white px-3 py-2.5 text-sm text-black outline-none transition-colors focus:border-black/25 focus:ring-2 focus:ring-black/10 sm:px-4";
        ...
        <div className="w-full overflow-hidden rounded-3xl border border-black/10 bg-white text-black shadow-[0_30px_90px_-60px_rgba(0,0,0,0.35)]">
          <div className="flex items-start justify-between gap-4 border-b border-black/10 p-6 sm:p-7">
            ...
            <button
              type="button"
              onClick={onClose}
              className="rounded-xl p-2 text-black/70 hover:bg-black/5 hover:text-black"
              aria-label="Close"
            >
              <X className="h-5 w-5" />
            </button>
          ...
          >
            ...
            <div>
              <label htmlFor="services" className="text-sm font-medium text-black">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div>
                <label htmlFor="years_experience" className="text-sm font-medium text-black">
            ...
            <div>
              <label htmlFor="areas_covered" className="text-sm font-medium text-black">
            ...
            <div className="rounded-2xl border border-black/10 bg-black/[0.02] p-4">
              ...
              <div className="mt-4 space-y-4">
                <div>
                  <label htmlFor="profile_photo" className="text-sm font-medium text-black">
                    Photo / logo (optional)
                  </label>
                  <input
                    id="profile_photo"
                    ...
                    className={`${field} file:mr-3 file:rounded-md file:border-0 file:bg-black/5 file:px-3 file:py-1.5 file:text-sm file:font-medium file:text-black`}
                  />
                ...
                <div>
                  <label htmlFor="certifications" className="text-sm font-medium text-black">
                ...
                <div>
                  <label htmlFor="insurance" className="text-sm font-medium text-black">
                ...
                <div>
                  <label htmlFor="dbs" className="text-sm font-medium text-black">
                    DBS check (optional)
                  </label>
                  <input
                    id="dbs"
                ...
                <div>
                  <label htmlFor="sample_reports" className="text-sm font-medium text-black">
